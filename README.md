...
Current documented release: `v0.29.0`.
...
```bash
scripts/install-ascendkit.sh --version 0.29.0
...
```bash
scripts/verify-release-assets.sh --version 0.29.0
```
...
scripts/verify-homebrew-formula.sh --version 0.29.0
