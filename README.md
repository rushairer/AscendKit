...
```bash
scripts/install-ascendkit.sh --version 1.9.1
...
```bash
scripts/verify-release-assets.sh --version 1.9.1
```
...
scripts/verify-homebrew-formula.sh --version 1.9.1
scripts/diagnose-homebrew-install.sh --version 1.9.1
scripts/sync-homebrew-tap.sh --commit --push
scripts/finalize-homebrew-release.sh --version 1.9.1 --commit --push --reinstall
scripts/v1-release-readiness.sh --version 1.9.1 --app-root /path/to/RepresentativeApp
