...
```bash
scripts/install-ascendkit.sh --version 1.4.6
...
```bash
scripts/verify-release-assets.sh --version 1.4.6
```
...
scripts/verify-homebrew-formula.sh --version 1.4.6
scripts/diagnose-homebrew-install.sh --version 1.4.6
scripts/sync-homebrew-tap.sh --commit --push
scripts/finalize-homebrew-release.sh --version 1.4.6 --commit --push --reinstall
scripts/v1-release-readiness.sh --version 1.4.6 --app-root /path/to/RepresentativeApp
